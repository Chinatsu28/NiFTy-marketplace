    ...
    !function(e, t) {
      ...
      r.VantaBase = class {
        constructor(e2 = {}) {
          ...
          if (this.options = Object.assign({ mouseControls: true, touchControls: true, gyroControls: false, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, t2), (e2 instanceof HTMLElement || "string" == typeof e2) && (e2 = { el: e2 }), Object.assign(this.options, e2), this.options.THREE && (n = this.options.THREE), this.el = this.options.el, null == this.el)
            h('Instance needs "el" param!');
          else if (!(this.options.el instanceof HTMLElement)) {
            const e3 = this.el;
            if (this.el = (i2 = e3, document.querySelector(i2)), !this.el)
              return void h("Cannot find element", e3);
          }
          var i2;
            ...
            t2.setup = function() {
              e2.initP5(t2), t2.smooth(), t2.noStroke(), function() {
                ...
                for (let e3 = 0; e3 < r2; e3++) {
                  ...
                  for (let s2 = 0; s2 < n2; s2++)
                    t3.push(p2(3e-3 * s2, 3e-3 * e3, 0.1));
                  h2.push(t3);
                }
              }();
            }, t2.draw = function() {
              t2.translate(-100, -100), function() {
                ...
                for (let e3 = 0; e3 < a2.length; e3++)
                  l.Vector.dist(a2[e3].prev, a2[e3].pos) < 10 && t2.line(a2[e3].prev.x, a2[e3].prev.y, a2[e3].pos.x, a2[e3].pos.y);
              }(), c2 += 2e-3;
            };
          });
        }
